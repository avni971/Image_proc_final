...
# noinspection PyUnresolvedReferences
def apply_shape_detection(image_name):
...
def apply_ex2_detection(image_full_location: str = None, folder_location: str = None):
    """
    ...
    if image_full_location is not None and folder_location is None:
        ...
        apply_shape_detection(image_full_location)
...
# apply_ex2_detection(image_full_location="D:/Lidor/Study/P.Languages/Python/Workspace_2019/ImageProcessing/Final/images/M40967-1-E.jpg")
# apply_ex2_detection(folder_location="D:/Study/P.Languages/Python/Workspace_2019/ImageProcessing/Final/images/")
# apply_ex2_detection()

# python -c "import projectIM2022_q2; from projectIM2022_q2 import apply_ex2_detection; apply_ex2_detection(
